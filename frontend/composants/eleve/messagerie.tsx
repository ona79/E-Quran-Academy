    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 h-[75vh]">
              ...
              return (
                <li key={id}>
                  <button
                    ...
                    onMouseEnter={(e) => {
                      if (interlocuteurId !== id) e.currentTarget.style.background = 'rgba(11,94,69,0.15)';
                    }}
                    onMouseLeave={(e) => {
                      if (interlocuteurId !== id) e.currentTarget.style.background = 'transparent';
                    }}
                  >
                    ...
                    {dernier && (
                      <p className="text-xs truncate mt-0.5" style={{ color: 'rgba(240,237,230,0.4)' }}>
                        {dernier.contenu}
                      </p>
                    )}
                  </button>
      ...
      >
        {!interlocuteurId ? (
          ...
          <>
            {/* Topbar conversation */}
            <div className="flex items-center gap-3 border-b pb-3 mb-3" style={{ borderColor: 'var(--bordure)' }}>
              <button
                type="button"
                  ...
                  return (
                    ...
                    >
                      <div
                        ...
                        style={{
                          background: envoye
                            ? 'linear-gradient(135deg, #0B5E45, #0D7055)'
                            : '#1A2F22',
                          color: 'white',
                      ...
                      <span className="text-[10px] opacity-50 px-1" style={{ color: '#F0EDE6' }}>
            ...
            {erreur && (
              <p className="text-xs py-1 px-4" style={{ color: '#F87171' }}>{erreur}</p>
            )}
